...
async function seed() {
    const uri = process.env.MONGO_URI || index_js_1.CONFIG.DEFAULT_MONGO_URI;
    ...
    try {
        ...
        const userIds = [new mongodb_1.ObjectId(), new mongodb_1.ObjectId(), new mongodb_1.ObjectId(), new mongodb_1.ObjectId(), new mongodb_1.ObjectId()];
